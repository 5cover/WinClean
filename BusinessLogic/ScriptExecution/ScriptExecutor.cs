...
public class ScriptExecutor
{
    ...
    public async Task ExecuteScriptsAsync(IReadOnlyList<Script> scripts, TimeSpan timeout, Func<string, bool> promptEndTaskOnHung, Func<Exception, FileSystemInfo, FSVerb, bool> promptRetryOnFSError)
        => await Task.Run(() =>
        {

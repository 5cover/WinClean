...
public static class AppInfo
{
    ...
    public static Lazy<IReadOnlyDictionary<string, Category>> Categories { get; } = Deserialize(deserializer.MakeCategories, "Categories.xml");
    ...
    public static Lazy<IReadOnlyDictionary<string, Host>> Hosts { get; } = Deserialize(deserializer.MakeHosts, "Hosts.xml");
    ...
    public static Lazy<IReadOnlyDictionary<string, Impact>> Impacts { get; } = Deserialize(deserializer.MakeImpacts, "Impacts.xml");
    ...
    public static Lazy<IReadOnlyDictionary<string, RecommendationLevel>> RecommendationLevels { get; } = Deserialize(deserializer.MakeRecommendationLevels, "RecommendationLevels.xml");

    #endregion Script metadata

    private static Lazy<IReadOnlyDictionary<string, T>> Deserialize<T>(Func<Stream, IEnumerable<T>> deserialize, string filename) where T : ScriptMetadata

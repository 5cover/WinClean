...
public sealed partial class ExecutionInfoView
{
    ...
    private void TextEditor_Scroll(object sender, System.Windows.Controls.Primitives.ScrollEventArgs e) => ((ExecutionInfoViewModel)DataContext).NotifyScroll.Execute(e);
}